...
rem      PAIEMENT CLIENT\ASCOMA\<ANNEE_PAIEMENT>\<ANNEE_SOINS>\<DATE_PAIEMENT> ASCOMA <ANNEE> <PERIODE> MONTANT <MONTANT>Ar.xlsx
rem      ex : ASCOMA\2025\2024\09-01-25 ASCOMA 2025 13-05-24 a 31-08-24 MONTANT 7 035 543Ar.xlsx
